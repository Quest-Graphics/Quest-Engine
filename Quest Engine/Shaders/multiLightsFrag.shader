...
vec3 pointLightCalc(Light light, vec3 viewDir, vec3 normal)
{
	...
	vec3 ambient = light.ambient * Ka * light.color * objColor;
	vec3 diffuse = light.diffuse * Kd * light.color * objColor;
	vec3 specular = light.specular * Ks * light.color * objColor;
